...
import { GlobalReachData } from "../../data/index";
      ...
      <div className="container">
        <div className="pt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-10">
          {GlobalReachData.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center border border-white/10 gap-4 bg-white/5 py-4 md:py-8 px-5 md:px-6 rounded-md"
            >
