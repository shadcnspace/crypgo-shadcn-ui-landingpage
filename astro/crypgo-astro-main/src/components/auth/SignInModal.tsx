...
const GoogleIcon = () => (
  <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_google_sim)">
    ...
    <defs><clipPath id="clip0_google_sim"><rect width="22" height="22" fill="white" transform="translate(0.5)" /></clipPath></defs>
  </svg>
);
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-9">
          <button
            type="submit"
            disabled={loading}
            className="bg-primary text-background w-full py-4 rounded-lg text-lg font-medium border border-primary hover:text-primary hover:bg-transparent transition-all duration-300 disabled:opacity-70 flex items-center justify-center gap-2"
          >
            Sign In
      ...
      <div className="text-center">
        <a href="/forgot-password" className="mb-4 inline-block text-base text-white hover:text-primary transition-colors">
          Forgot Password?
        </a>
        <p className="text-white text-base mt-2">
          Not a member yet?{" "}
          <button onClick={onClose} className="text-primary hover:underline">Sign Up</button>
        </p>
      </div>
    </Modal>
  );
