...
const GoogleIcon = () => (
  <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_google_sum)">
    ...
    <defs><clipPath id="clip0_google_sum"><rect width="22" height="22" fill="white" transform="translate(0.5)"/></clipPath></defs>
  </svg>
);
...
const SignUpModal = ({ onClose }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Simulate registration success and close modal
    ...
    <Modal onClose={onClose}>
      ...
      <div className="text-center">
        ...
        <p className="text-white text-base">
          ...
          <button onClick={onClose} className="pl-1 text-primary hover:underline">Sign In</button>
        </p>
      </div>
    </Modal>
  );
